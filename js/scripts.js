...
jQuery(function(){	
	...
	jQuery('#embedtweet-tweet').each(function() {  
	...
	jQuery('#embedtweet-text').each(function() {
	...
	jQuery('#embedtweet-copylink').click(function(){
	...
	jQuery('#embedtweet-submit').click(function(){
